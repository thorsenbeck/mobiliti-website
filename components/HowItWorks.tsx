...
const steps = [
  ...
  },
  {
    ...
    description: 'Vi matcher din forælder med en fast fysioterapeutstuderende fra vores hold — alle på 3. semester eller derover og oplært i Mobiliti-metoden. Samme ansigt fra uge til uge giver tryghed og kontinuitet.',
  ...
  },
  {
    ...
    description: 'Terapeuten kommer hjem til din forælder 1-3 gange ugentligt. Hver session er 45 minutter med aktiv træning, information og statusopdatering. Programmet evalueres månedligt af supervisor-fysioterapeuten.',
